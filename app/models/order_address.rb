class OrderAddress
  ...
  attr_accessor :item_id, :user_id, :postcode, :ship_from_id, :city, :block, :building, :phone_number, :token
  ...
  def save
    ...
    address = Address.create(postcode: postcode, ship_from_id: ship_from_id, city: city, block: block, building: building,
